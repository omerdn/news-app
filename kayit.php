...
<?php include("header.php"); ?>
    <div class="flex items-center justify-around pt-32 mx-auto">
        <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-sm">
            ...
            <form action="kayitSQL.php" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="email" name="email" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="E-Posta adresi girin">
                </div>
                <div class="mb-6">
