        ...
        <div class="w-5/6 mx-auto bg-slate-50 flex-grow flex">
            <main class="p-8 w-full">
                ...
                if (isset($_GET['haberID'])) {
                    ...
                    echo '    <form action="adminHaberEdit.php" method="post" enctype="multipart/form-data">';
                    echo '        <div class="mb-4">';
                    ...
                    echo '        </div>';
                    echo '        <div class="mb-4">';
                    echo '            <label for="haberIcerik" class="block text-gray-700 font-bold mb-2">Kategori</label>';
